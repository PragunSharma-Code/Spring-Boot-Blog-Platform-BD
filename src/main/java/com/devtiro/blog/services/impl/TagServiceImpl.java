...
public class TagServiceImpl implements TagService {
    ...
    public void deleteTag(UUID id) {
        Optional<Tag> checkIfTagExists = tagRepository.findById(id);
        if(checkIfTagExists.isEmpty()){
            throw new IllegalStateException("Cannot delete tag with posts associated to it");
        }
